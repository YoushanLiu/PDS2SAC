function pds2sac24_with_clock_drafting_correction
...
input_data_folder = './JD.Group4.Raw';
...
period_folders_list = dir([period_path, 'DATA_*']);
...
for k = 62:-1:1
    ...
    if ((clock_block1(1,lp) == GPS_locked_end.Day) && (clock_block1(1,lp_prev) == GPS_locked_start.Day))
        ptr_clock1_last = lp;
        break;
    end
    lp = lp - 1;
...
for k = 62:-1:1
    ...
    %if ((Day == GPS_locked_end.Day) && (Hour == GPS_locked_end.Hour)
        isfound = true;
        ptr_clock1_end = lp;
    end
