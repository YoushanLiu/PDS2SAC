...
% mem_total = bin2dec(num2str([bitget(packet(17),8:-1:1), bitget(packet(18),8:-1:1), bitget(packet(19),8:-1:1), bitget(packet(20),8:-1:1)]));
% mem_used = bin2dec(num2str([bitget(packet(25),8:-1:1), bitget(packet(26),8:-1:1), bitget(packet(27),8:-1:1), bitget(packet(28),8:-1:1)]));
